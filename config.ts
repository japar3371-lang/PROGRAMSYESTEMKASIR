export const APP_NAME = "Sistem Kasir Kantin Sekolah";
...
export const PAJAK_NORMA = 0.10;
export const PEMBELAAN_DISKON = 0;
...
export const PASSWORD_PENJUAL = "admin123";
export const STOK_HAMPIR_HABIS = 5;
export const STOK_HABIS = 0;

export const PERINGATAN_POIN = 10000;